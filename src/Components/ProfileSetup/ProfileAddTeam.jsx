...
function ProfileAddTeam() {
  ...
  const data = {
    ...
    logo_url: {
      url: "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.flaticon.com%2Ffree-icon%2Fprofile_3135715&psig=AOvVaw1wK-h1aYs2LbfSzD4HduwZ&ust=1712382321844000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCLjet7GvqoUDFQAAAAAdAAAAABAE",
    },
    departments: {
  ...
  const cv = {
    logo: "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.flaticon.com%2Ffree-icon%2Fprofile_3135715&psig=AOvVaw1wK-h1aYs2LbfSzD4HduwZ&ust=1712382321844000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCLjet7GvqoUDFQAAAAAdAAAAABAE",
    detailed_data: data,
  ...
  const post_Method = () => {
    // axios POST request
    const options = {
      url: "https://smart-cruiter-1.onrender.com/profile/setup",
      method: "POST",
      headers: {
